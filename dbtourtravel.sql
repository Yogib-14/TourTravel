...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 01 Jun 2020 pada 19.31
...
CREATE TABLE `paket_tour` (
  ...
  `gambar_tour` varchar(255) NOT NULL,
  `nama_paket` varchar(255) NOT NULL,
  `durasi_tour` varchar(255) NOT NULL,
...
INSERT INTO `paket_tour` (`id_paket`, `gambar_tour`, `nama_paket`, `durasi_tour`, `hotel`, `makan`, `transportasi`, `wisata`, `harga`, `tanggal`, `status`) VALUES
(1, 'picture/paket_tour/tour1.jpg', 'Jakarta - Bali', '3 Hari 3 Malam', 'Hotel bintang 5 di Nusa Dua', 'Breakfast, lunch, dinner', 'Pesawat Pulang - Pergi, Bus Wisata', 'Bedugul, Uluwatu, Tanah lot', 2000000, '2020-07-27', 'aktif'),
(3, 'picture/paket_tour/komodo.jpg', 'Jakarta - Nusa Tenggara Timur', '2 hari 1 malam', 'Hotel bintang 4 di Puri Sari Beach', 'Breakfast, launch, dinner, snack', 'Pesawat Pulang-Pergi, Mini Van', 'Taman Nasional Komodo, Pink beach', 1500000, '2020-07-15', 'aktif'),
(7, 'picture/paket_tour/715581.jpg', 'BLEON', '', '', '', '', '', 0, '2020-05-11', 'tidak'),
(8, 'picture/paket_tour/715581.jpg', '', '', '', '', '', '', 0, '2020-05-12', 'tidak'),
(9, 'picture/paket_tour/715581.jpg', 'Bleon', '1221', 'dsaknlndsa', 'asdkldasknl', 'sdaklnklsad', 'sadknlsdlak', 1320341, '2020-05-04', 'tidak');

-- --------------------------------------------------------

--
-- Struktur dari tabel `record_pembelian`
--

CREATE TABLE `record_pembelian` (
  ...
  `nama_kartu` varchar(255) NOT NULL,
  `nomer_kartu` varchar(255) NOT NULL,
  `expired_month` varchar(255) NOT NULL,
  `expired_year` varchar(255) NOT NULL,
  `cvv` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data untuk tabel `record_pembelian`
--

INSERT INTO `record_pembelian` (`id_pembelian`, `id_customer`, `id_paket`, `nama_customer`, `email`, `id_provinsi`, `id_kabupaten`, `alamat`, `nama_kartu`, `nomer_kartu`, `expired_month`, `expired_year`, `cvv`) VALUES
(1, 2, 1, 'Andreas Yogi Brata', 'andreas@gmail.com', 36, 3674, 'The Castilla', 'Andreas Yogi Brata', '1234567890123456', '08', '2020', '123'),
(2, 2, 1, 'YOgi brata', 'anbde@gmail.com', 11, 1101, 'Yogi1243', 'Andreas', '0987656765456765', '09', '2020', '123'),
(3, 2, 1, 'Yogi', 'daa', 34, 3402, 'da', 'dsa', '2', '23', '2332', '123'),
(4, 2, 1, 'Agung', 'Andber@gmail.com', 34, 3402, 'Coba123', 'ad', '01', '12', '2002', '123'),
(5, 2, 1, 'Yogi', 'anber@gmail.com', 35, 3518, 'Nganjuk123', 'Andreas', '1234123412341234', '09', '2020', '123'),
(6, 2, 1, 'ad', 'da@gmail.com', 35, 3517, 'da', 'da', '23', '02', '2341', '123'),
(7, 2, 1, 'da', 'dsasdsd', 36, 3601, 'wad', 'sda', '1234123412341234', '12', '1234', '123'),
(8, 2, 1, 'da', 'sadksand@gmail.com', 11, 1103, 'sdasd23', 'dsa', '2', '23', '2342', '123'),
(9, 2, 1, 'dada', 'coba', 14, 1409, 'csadsa', 'sdasaddsa', '0912839020123213', '12', '1234', '123'),
(10, 2, 3, 'saddsa', 'saf', 34, 3402, 'sad', 'sadas', '2324', '12', '1234', '123');

-- --------------------------------------------------------

--
-- Struktur dari tabel `request_tour`
--

CREATE TABLE `request_tour` (
  `id_request` int(11) NOT NULL,
  `id_provinsi_asal` int(11) NOT NULL,
  `id_provinsi_tujuan` int(11) NOT NULL,
  `durasi_tour` varchar(100) NOT NULL,
...
--
-- Dumping data untuk tabel `request_tour`
--

INSERT INTO `request_tour` (`id_request`, `id_provinsi_asal`, `id_provinsi_tujuan`, `durasi_tour`, `hotel`, `makan`, `transportasi`, `wisata`, `harga`) VALUES
(2, 11, 15, 'sad', 'sa', 'sad', 'sada', 'wsa', 'sad'),
(3, 11, 12, '3 hari 3 malam', 'hotel bintang 4', 'makan pagi, siang, malam', 'Pesawat Garuda, bis pariwisata', 'Tugu Monas', 'Antara Rp1 juta - 3 juta'),
(4, 15, 31, '2 hari 2 malam', 'hotel bintang 4', 'Makan - makan', 'Pesawat Garuda, bis pariwisata', 'Tugu Monas', 'Antara Rp1 juta - 3 juta'),
(5, 14, 12, 'tes', 'tes', 'we', 'tes', 'tws', 'we');
...
INSERT INTO `user` (`id`, `username`, `password`, `role`, `nama`, `noTelp`, `tanggal_lahir`, `id_provinsi`, `id_kabupaten`, `id_kecamatan`, `alamat`) VALUES
(2, 'andreas', '$2y$10$xf.uWsZOLZUZjdi.0a/w.OQkBfkDiqr0DCRQdB02I0vvhY2hQvfT6', 'customer', '', '', '0000-00-00', '36', '3674', '3674020', ''),
(3, 'test', '$2y$10$Asfb/pQpr/ATrTl49xBZx.AOg4BovJaBw5UNaNlQrAA7/SPqmPCbO', 'customer', '', '', '0000-00-00', '36', '3671', '3671031', ''),
(4, 'coba2', '$2y$10$T.YolqlzylqDRtQ2zac27ObcUwPft994FPCKA.60bjRLSBDJ5HCm.', 'customer', 'andreas yogi brata', '098767635473', '2000-08-14', '36', '3674', '3674020', 'BSD '),
(5, 'agung', '$2y$10$oR/ZFnubuJDw6N1HAYimwu5DrCG3imQ.dCZnx30VD2iyTiQAi8Fpi', 'customer', 'Agoeng', '085938471482', '2020-05-04', '36', '3671', '3671021', 'sadjnokdsajoidsahidsa'),
(6, 'adminumn', '$2y$10$0tJq/jroY8RNqX7ynhXvU.ZuCWXWLXDS0JinpQllq1ABQF5t8du72', 'staff', 'admin', '082938475728', '2000-08-14', '36', '3603', '3603051', 'AdminUMNcoba');
...
--
-- Struktur dari tabel `wilayah_provinsi_tujuan`
--

CREATE TABLE `wilayah_provinsi_tujuan` (
  `id` varchar(2) NOT NULL,
  `nama_tujuan` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `wilayah_provinsi_tujuan`
--

INSERT INTO `wilayah_provinsi_tujuan` (`id`, `nama_tujuan`) VALUES
('11', 'Aceh'),
('12', 'Sumatera Utara'),
('13', 'Sumatera Barat'),
('14', 'Riau'),
...
--
-- Indeks untuk tabel `record_pembelian`
--
ALTER TABLE `record_pembelian`
  ADD PRIMARY KEY (`id_pembelian`);

--
-- Indeks untuk tabel `request_tour`
--
...
--
-- Indeks untuk tabel `wilayah_provinsi_tujuan`
--
ALTER TABLE `wilayah_provinsi_tujuan`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT untuk tabel `record_pembelian`
--
ALTER TABLE `record_pembelian`
  MODIFY `id_pembelian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT untuk tabel `request_tour`
--
ALTER TABLE `request_tour`
